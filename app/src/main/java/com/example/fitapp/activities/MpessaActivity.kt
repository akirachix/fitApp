...
import com.example.fitapp.databinding.ActivityMpesa2Binding

class MpessaActivity : AppCompatActivity() {
    lateinit var binding: ActivityMpesa2Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMpesa2Binding.inflate(layoutInflater)
