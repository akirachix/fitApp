...
import com.example.fitapp.databinding.FragmentMpessaBinding

class MpessaFragment : Fragment() {

    private var _binding:FragmentMpessaBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMpessaBinding.inflate(inflater, container, false)
