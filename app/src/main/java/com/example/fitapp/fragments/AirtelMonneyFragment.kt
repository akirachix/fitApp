...
import com.example.fitapp.databinding.FragmentAirtelMonneyBinding

class AirtelMonneyFragment : Fragment() {

    private var _binding:FragmentAirtelMonneyBinding ?=null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAirtelMonneyBinding.inflate(layoutInflater,container,false)
